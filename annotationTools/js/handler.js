...
function handler() {
    ...
    //function added by ashish
    this.doneBtnClicked = function(nn,new_attributes, new_occluded, username, dirName, collectionName, imageName) {
      // alert('Done clicked !');
      // console.log(nn,new_attributes, new_occluded,username, dirName, imageName);


      $.post('http://localhost/labelme/admin/api_save_annotations.php', {  objEnter :nn, attributes: new_attributes, occluded:new_occluded,username: username, dirName: dirName, collectionName: collectionName, imageName:imageName}, function(data){

                  if(data.status == 'success'){
                    console.log('data saved successfully ');
                  }else{
                    console.log('data NOT saved in db ! try again.');
                  }
	...
	anno.RenderAnnotation('rest');
      ...
      console.log(main_media.GetFileInfo());
      var collectionName = main_media.GetFileInfo().GetCollection();
      this.doneBtnClicked(nn,new_attributes, new_occluded,username,main_media.GetFileInfo().GetDirName(),collectionName, main_media.GetFileInfo().GetImName());
      return anno;
    };
