        ...
        if((idx != -1) && (this.page_in_use == 0)) {
            ...
            do {
                ...
                if(par_field=='mode'){
					...
					//	$('#prevImage').hide();
						if (bname == 'Netscape'){
							$('#label_buttons_contrast').css('left', '575px');
						}
						else $('#label_buttons_contrast').css('left', '555px');
					}
					else{
						$('#prevImage').show();
						if (bname == 'Netscape'){
							$('#label_buttons_contrast').css('left', '605px');
						}
						else $('#label_buttons_contrast').css('left', '585px');
                ...
                if(par_field=='image') {
                    ...
                    if(this.im_name.indexOf('.jpg')==-1 && this.im_name.indexOf('.png')==-1 && this.im_name.indexOf('.bmp')==-1 && this.im_name.indexOf('.jpeg')==-1) {
