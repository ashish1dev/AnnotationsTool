...
function DrawCanvasClosePolygon() {
  ...
  if (video_mode){
    ...
    // Done button:
    html_str += '<input type="button" value="Done2" title="Press this button after you have provided all the information you want about the object." onclick="main_media.SubmitObject();" tabindex="0" />';
