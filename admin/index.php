...
if(isset($_POST['submit'])){
	...
	if(!filter_var($email, FILTER_VALIDATE_EMAIL)){
		...
		$stmt = $db->prepare('SELECT email FROM admin_members WHERE email = :email');
	...
	if(!isset($error)){
		...
		try {
			...
			$stmt = $db->prepare('INSERT INTO admin_members (username,password,email,active) VALUES (:username, :password, :email, :active)');
			$stmt->execute(array(
				':username' => $username,
