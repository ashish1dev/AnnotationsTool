...
$stmt = $db->prepare('SELECT resetToken, resetComplete FROM admin_members WHERE resetToken = :token');
...
if(isset($_POST['submit'])){
	...
	if(!isset($error)){
		...
		try {
			...
			$stmt = $db->prepare("UPDATE admin_members SET password = :hashedpassword, resetComplete = 'Yes'  WHERE resetToken = :token");
			$stmt->execute(array(
